package org.mundia.ebank_lastversion_backend.mappers;

import org.mundia.ebank_lastversion_backend.dtos.AccountOperationDTO;
import org.mundia.ebank_lastversion_backend.dtos.CurrentBankAccountDTO;
import org.mundia.ebank_lastversion_backend.dtos.CustomerDTO;
import org.mundia.ebank_lastversion_backend.dtos.SavingBankAccountDTO;
...
public class BankAccountMapperImp {
    public CustomerDTO fromCustomer(Customer customer){
        ...
        BeanUtils.copyProperties(customer,customerDTO); //transfer or prender les attriute de customer vers customerDTO elle remplace set set set ex: customerDTO.setId(customer.getId());
        return customerDTO;
    }
