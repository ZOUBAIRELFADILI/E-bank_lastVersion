package org.mundia.ebank_lastversion_backend;
...
public class EBankLastVersionBackendApplication {

    public static void main(String[] args) {
        SpringApplication.run(EBankLastVersionBackendApplication.class, args);
    }
    @Bean
    ...
    //@Bean //la premier partie de test
